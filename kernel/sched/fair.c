...
unsigned int sched_capacity_margin_up_boosted[NR_CPUS] = {
	3658, 3658, 3658, 3658, 3658, 3658, 1078, 1078}; /* 72% margin for small, 5% for big */
unsigned int sched_capacity_margin_down_boosted[NR_CPUS] = {
	3658, 3658, 3658, 3658, 3658, 3658, 3658, 3658}; /* not used for small cores, 72% margin for big */
